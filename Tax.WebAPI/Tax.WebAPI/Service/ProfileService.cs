...
namespace Tax.WebAPI.Service
{
    public class ProfileService
    {
        ...
        public UserProfile GetUserProfile(string username)
        {
            ...
            var pbxProfile = context.PBXExtensionData.Where(p => p.ApplicationUser.Id == user.Id && p.isDroped == false).SingleOrDefault();
            ...
            if (pbxProfile != null)
            {
                return new UserProfile
                {
                    ...
                    PBXExtension = pbxProfile.PhoneNumber.InnerPhoneNumber,
